  ...
  return (
    <div style={{ background: 'var(--color-bg)', minHeight: '100vh', padding: '0 0 48px' }}>
      ...
      <div style={{
        ...
        <div style={{ fontSize: 12, opacity: 0.65 }}>Samagama Internship Portal · <strong>Moderator Dashboard</strong></div>
      </div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 18 }}>
        ...
        <span style={{ fontSize: 19, fontWeight: 800, color: 'var(--color-text)', letterSpacing: '-0.02em' }}>Moderation Queue</span>
      </div>
