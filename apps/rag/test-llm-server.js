...
async function testGenerate() {
  ...
  try {
    const response = await axios.post(
      ...
      {
        system_instruction:
          "You are a helpful support bot. Use ONLY the provided context to answer. If the answer is not in the context, reply EXACTLY with: 'I don't have an answer for you at the moment. You can escalate it to backend team: Type #escalate'.",
        rag_context: [
